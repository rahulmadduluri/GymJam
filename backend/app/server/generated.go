...
type ComplexityRoot struct {
	Mutation struct {
		...
		UpdateStudent func(childComplexity int, userInfo models.UpdateUserInput) int
	}
...
type MutationResolver interface {
	...
	UpdateStudent(ctx context.Context, userInfo models.UpdateUserInput) (bool, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateStudent":
		...
		return e.complexity.Mutation.UpdateStudent(childComplexity, args["userInfo"].(models.UpdateUserInput)), true
...
type Mutation {
  ...
  updateStudent(userInfo: UpdateUserInput!): Boolean! #@isAuthenticated
}
`},
)
...
func (ec *executionContext) _Mutation_updateStudent(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateStudent(rctx, args["userInfo"].(models.UpdateUserInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
